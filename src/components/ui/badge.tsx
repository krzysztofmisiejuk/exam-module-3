...
const badgeVariants = cva(
	'inline-flex items-center justify-center rounded-md border text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden',
	{
		variants: {
			variant: {
				primary:
					'bg-blaze-orange-50 text-primary-800 rounded-md border-none text-sm',
				light:
					'bg-white text-neutral-900 rounded-md border border-gray-200 shadow-sm-custom shadow-md-custom',
				default:
					'border-gray-200 bg-white text-primary-foreground [a&]:hover:bg-primary/90',
				secondary:
				...
				success:
					'bg-success-50 text-success-800 rounded-md border-none text-sm',
			},
			size: {
				L: 'px-[6px] py-[10px]',
				M: 'px-[2px] py-[10px]',
